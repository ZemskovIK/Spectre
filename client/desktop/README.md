...
## 🌿 Ветки проекта
- `main` - основная версия с полной функциональностью, аутентификацией и шифрованием
...
python main.py
```
> Или запустите spectre.exe из папки dist
...
- Ключи сессии: генерируются при каждом запуске через ECDH, не сохраняются на диске
